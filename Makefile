...
#    Updated: 2017/01/08 20:12:29 by rclanget         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC		= 	ft_atoi.c ft_bzero.c ft_escape.c ft_isalnum.c ft_isalpha.c \
			t_isascii.c ft_isdigit.c ft_isprint.c ft_isspace.c ft_isupper.c \
			...
			ft_nbrlen.c ft_option.c ft_print.c ft_putchar.c ft_putchar_fd.c \
			...
			ft_strtrim.c ft_tolower.c ft_toupper.c get_next_line.c ft_putstr.c \
			ft_strlcat.c ft_strsub.c
